$(document).ready(function() {
  ...
  var deleteTask = function (id) {
    $.ajax({
      type: 'DELETE',
      url: 'https://altcademy-to-do-list-api.herokuapp.com/tasks/' + id 
      + '?api_key=225',
      success: function (response, textStatus) {
        getAndDisplayAllTasks();
      },
...
var markTaskActive = function (id) {
  $.ajax({
    type: 'PUT',
    url: 'https://altcademy-to-do-list-api.herokuapp.com/tasks/' + id + '/mark_active?api_key=225',
    dataType: 'json',
    success: function (response, textStatus) {
      getAndDisplayAllTasks();
    },
